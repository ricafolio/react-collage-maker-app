...
export const ASPECT_RATIOS: AspectRatioType[] = [
  {
    name: "1:1",
    nickname: "Square",
    getCanvasSize: (WIDTH) => calculateAspectRatio(1, 1, WIDTH),
  ...
  },
  {
    name: "2:1",
    nickname: "FB Post",
    getCanvasSize: (WIDTH) => calculateAspectRatio(2, 1, WIDTH),
  ...
  },
  {
    ...
    getCanvasSize: (WIDTH) => calculateAspectRatio(2, 3, WIDTH),
  ...
  },
  {
    ...
    getCanvasSize: (WIDTH) => calculateAspectRatio(3, 1, WIDTH),
  ...
  },
  {
    ...
    getCanvasSize: (WIDTH) => calculateAspectRatio(3, 4, WIDTH),
  ...
  },
  {
    name: "4:3",
    nickname: "Standard",
    getCanvasSize: (WIDTH) => calculateAspectRatio(4, 3, WIDTH),
  ...
  },
  {
    name: "9:16",
    nickname: "Stories",
    getCanvasSize: (WIDTH) => calculateAspectRatio(9, 16, WIDTH),
  ...
  },
  {
    name: "16:9",
    nickname: "Cinematic",
    getCanvasSize: (WIDTH) => calculateAspectRatio(16, 9, WIDTH),
